...
export const metadata: Metadata = {
  ...
  description:
    "ABR Electric is your trusted local business for licensed electricians in McKinney, TX. TECL #27762. Expert electrical services with 5-star ratings. Call (214) 690-1941 today!",
  alternates: {
    canonical: "https://abrelectric.com/mckinney",
  },
}
